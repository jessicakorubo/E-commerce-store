...
// $stmt1= $conn->prepare("SELECT COUNT()");
// $stmt1->execute();
// $products = $stmt1->get_result();
        ...
        <section class="product-body view-flex">
            ...
            <div class="product-cards">
                <div class="product-card">
                    <div class="card-div">
                        <div class="icon">
                            <i class="fa-solid fa-dollar-sign sales"></i>
                        </div>
                        <div class="info">
                            <p>Total Sales</p>
                            <hr>
                ...
                <div class="product-card">
                    <div class="card-div">
                        <div class="icon">
                            <i class="fa-solid fa-dollar-sign orders"></i>
                        </div>
                        <div class="info">
                            <p>Total Orders</p>
                            <hr>
                ...
                <div class="product-card">
                    <div class="card-div">
                        <div class="icon">
                            <i class="fa-solid fa-dollar-sign sold"></i>
                        </div>
                        <div class="info">
                            <p>Sold products</p>
                            <hr>
                ...
                <div class="product-card">
                    <div class="card-div">
                        <div class="icon">
                            <i class="fa-solid fa-dollar-sign products"></i>
                        </div>
                        <div class="info">
